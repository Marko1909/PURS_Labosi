...
SELECT ime, prezime, vrijednost AS vrijednost_temeprature FROM korisnikove_temperature
INNER JOIN korisnik ON korisnikove_temperature.id_korisnika = korisnik.id
